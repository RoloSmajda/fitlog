...
export const PresetsPreview: FC<Props> = ({ loadExercisesFromPreset }) => {
  ...
  const [presetToDisplayName, setPresetToDisplayName] = useState<
    string | undefined
  >("");
  const [presetToDisplayId, setPresetToDisplayId] = useState<
    string | undefined
  >("");
  ...
  if (presets !== null && presets.length < 1) {
    return (
      <div className="emptyExercises">
        This workout has no exercises. Use "Add exercise" button to add
    ...
    <div className="presets">
      <ThemeProvider theme={theme}>
        <div className="presetsRow">
          ...
          <Button onClick={openPresetOptions} color="primary">
            <ArrowDropDownIcon />
            Presets
          </Button>
        </div>
      ...
      <div className="emptyExercises">
        This workout has no exercises. Use "Add exercise" button to add
        exercises or choose from your saved presets.
      </div>
    </div>
  );
};
